...
public class Zombie : LivingEntity
{
    ...
    private NavMeshAgent navMeshAgent; // 경로 계선 AI 에이전트

    public ParticleSystem hitEffect; // 피격 시 재생할 파티클 효과
    public AudioClip deadthSound; // 사망 시 재생할 소리
    ...
    public override void Die()
    {
        ...
        // 사망 효과음 재생
        zombieAudioPlayer.PlayOneShot(deadthSound);
    }
